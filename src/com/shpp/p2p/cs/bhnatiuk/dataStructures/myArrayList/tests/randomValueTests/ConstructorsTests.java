...
/**
 * Class with tests for {@link MyArrayList} constructors, that uses random values for testing.
 */
public class ConstructorsTests implements TesterConstants {
    ...
    private static MyArrayList<Integer> testedArrayList;
...
//        System.out.println("End");
    ...
    private static void noParametersConstructor() {
        ...
        testedArrayList = new MyArrayList<>();
    ...
    private static void initSizeConstructor(int iterations) {
        ...
        for (int i = 0; i < iterations; i++) {
            ...
            testedArrayList = new MyArrayList<>(expArrayLength);
    ...
    private static void initSizeStepConstructor(int iterations) {
        ...
        for (int i = 0; i < iterations; i++) {
            ...
            testedArrayList = new MyArrayList<>(expArrayLength, expectedStep);
    ...
    private static void initArrayConstructor(int iterations) {
        ...
        for (int i = 0; i < iterations; i++) {
            ...
            testedArrayList = new MyArrayList<>(expectedArray);
    ...
    private static void initArrayStepConstructor(int iterations) {
        ...
        for (int i = 0; i < iterations; i++) {
            ...
            testedArrayList = new MyArrayList<>(expectedArray, expectedStep);
